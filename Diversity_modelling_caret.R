...
### load the LC data -----------------------------------------------------------------------
setwd("~/Dropbox/Projects/City4Bees/Data ready for analyses")
urb_18 <- stack(x = "Urban_perc_18.tif")
names(urb_18) <- paste("Urb",c(200, 500, 1000, 2500),sep="_")
urb_18
...
### make raster stack
setwd("C:/Users/Bertrand/Dropbox/Projects/City4Bees/Results_Diversity_Modelling")
rastlist <- list.files(path = "C:/Users/Bertrand/Dropbox/Projects/City4Bees/Results_Diversity_Modelling_2021-10-21", 
                       pattern='.tif$', all.files=TRUE, full.names=FALSE)
...
>>>>>>> 9968c3c676b2d2c7d59320660d7e19e42ed39d7a
